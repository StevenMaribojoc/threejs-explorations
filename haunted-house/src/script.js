...
wind.position.y = 1.2
wind.position.z = 0.01
wind.position.x = 2 + 0.01
...
const tick = () =>
{
    ...
    ghost2.position.y = Math.sin(ghost2Angle *4) + Math.sin(ghost2Angle*2.5) + 3
